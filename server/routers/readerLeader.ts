...
export const readerLeaderRouter = router({
  ...
  sessions: router({
    processAndSave: protectedProcedure.input(z.object({
      ...
      if ("error" in transcription) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "We could not process this recording. Guided completion is still available." });
